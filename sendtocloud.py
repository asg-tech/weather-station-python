...
class QueueHelloWorldSamples(object):
    ...
    connection_string = os.getenv("2e2e3d7c-5748-45c9-904e-4f1a262c155e")
    ...
    def queue_and_messages_example(self,classoutput):
        # Instantiate the QueueClient from a connection string
        from azure.storage.queue import QueueClient
        queue = QueueClient.from_connection_string(conn_str=self.connection_string, queue_name="weatherflow-asg-gaurang")
        ...
        try:
            # Send messages
            queue.send_message(classoutput)
